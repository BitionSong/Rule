...
[Script]
http-request ^https:\/\/(www|live)\.bilibili\.com\/?.? script-path=https://raw.githubusercontent.com/BitionSong/rule/master/surge3/Scripts/bilibili/bilibili.cookie.js
cron "10 0 0 * * *" script-path=https://raw.githubusercontent.com/BitionSong/rule/master/surge3/Scripts/bilibili/bilibili.js
```
